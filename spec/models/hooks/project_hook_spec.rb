...
describe ProjectHook do
  ...
  describe '.push_hooks' do
    it 'returns hooks for push events only' do
      hook = build_stubbed(:project_hook, push_events: true)
      build_stubbed(:project_hook, push_events: false)
  ...
  describe '.tag_push_hooks' do
    it 'returns hooks for tag push events only' do
      hook = build_stubbed(:project_hook, tag_push_events: true)
      build_stubbed(:project_hook, tag_push_events: false)
