  ...
  class Runner < Grape::API
    ...
    resource :jobs do
      ...
      params do
        ...
        optional 'file.compression', type: String, desc: %q(The compression algorithm of the artifact),
                                     default: 'zip', values: Ci::JobArtifact.compressions.keys
        ...
        optional 'metadata.compression', type: String, desc: %q(The compression algorithm of the metadata),
                                         default: 'gzip', values: Ci::JobArtifact.compressions.keys
      end
